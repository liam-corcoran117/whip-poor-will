...
# # Data for Common Pauraque (from the table)
...
mean_growth_mass_pauraque <- calculate_mean_growth_rate(growth_rate_summary_mass_pauraque)
mean_growth_tarsus_pauraque <- calculate_mean_growth_rate(growth_rate_summary_tarsus_pauraque)
mean_growth_wing_pauraque <- calculate_mean_growth_rate(growth_rate_summary_wing_pauraque)
...
print(paste("Pauraque Mass: Mean growth rate is", round(mean_growth_mass_pauraque, 2)))
print(paste("Pauraque Tarsus: Mean growth rate is", round(mean_growth_tarsus_pauraque, 2)))
print(paste("Pauraque Wing: Mean growth rate is", round(mean_growth_wing_pauraque, 2)))
